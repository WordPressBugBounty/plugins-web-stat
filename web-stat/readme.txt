...
* Visit Depths
* Time-on-site
* Users (name, email, photo of your site's users when signed-in)
* Conversions
...
= 2.6 =
* Released: 2025-04-19
* 2.6 Allow dashboard widget in guest mode
= 2.5.9 =
* Released: 2025-04-17
...
* housekeeping - stable version
= 2.2 =
* added better time zone management
= 2.1 =
* minor adjustments to the wp-admin interface
= 2.0 =
* rewrite of the plugin to enable faster loading time
= 1.6.6 =
* housekeeping - stable version
= 1.6.4 =
* housekeeping - stable version
...
* housekeeping - stable version
= 1.5 =
* this is a faster version for more precise stats
= 1.4.7 =
* housekeeping - stable version
= 1.4.6 =
* improved resizeable dashboard element
= 1.4.5 =
* housekeeping - stable version
= 1.4.4 =
* added users detection (if a user is signed-in we record his name, email, photo and show it in your stats)
= 1.4.3 =
* housekeeping - stable version
= 1.4.2 =
* housekeeping - stable version
...
* housekeeping - stable version
= 1.4 =
* mandatory update - compatibility PHP8 and WordPress 5.6
= 1.3.1 =
* housekeeping - stable version
= 1.3 =
* better caching and faster loading
= 1.2 =
* resolved rare conflict with other plugins
= 1.1.9 =
* improved French support and corrected some bugs. This version is faster and more reliable
= 1.1.8 =
...
= 1.1.3 =
* better compatibility for do-not-track browsers
= 1.1.2 =
* better compatibility for do-not-track browsers
= 1.1.1 =
* please upgrade to 1.1.1 for a more stable configuration
= 1.1.0 =
* new stats interface: view your stats and configure your account from within Wordpress
= 1.0.6 =
* added recent visitors to dashboard element.
= 1.0.5 =
* added dashboard element.
= 1.0.4 =
* corrected account creation bug.
= 1.0.3 =
added links to stats/settings/login info to plugin main page.
= 1.0.2 =
more graceful update process.
= 1.0.1 =
non essential modification of Web-Stat.php
= 1.0 =
* Initial release
...
= 2.5.7 =
* 2.5.7 bug corrected. Update is recommended
= 2.5.6 =
* 2.5.6 bug corrected. Update is recommended
= 2.5.3 =
